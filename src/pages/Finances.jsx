  ...
  const handleDeleteExpense = (item) => {
    if (isAutoGenerated(item)) {
      const confirmed = window.confirm(
        `Este gasto fue generado automáticamente desde: "${item.description}".\n\n⚠️ Eliminarlo NO revertirá el estado de planilla, vacaciones o descuentos. Solo se eliminará el registro contable.\n\n¿Deseas continuar?`
      );
      if (!confirmed) return;
    }
