  ...
  const handleDeleteExpense = (item) => {
    if (isAutoGenerated(item)) {
      const confirmed = window.confirm(
        `Este gasto fue generado automáticamente desde: "${item.description}".\n\nAl eliminarlo, el estado del trabajador (planilla, vacaciones o descuentos) será revertido automáticamente.\n\n¿Deseas continuar?`
      );
      if (!confirmed) return;
    }
